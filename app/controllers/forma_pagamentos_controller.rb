class FormaPagamentosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @forma_pagamento.save
        format.html { redirect_to @forma_pagamento, notice: t('message.create_success') }
  ...
  def update
    respond_to do |format|
      if @forma_pagamento.update(forma_pagamento_params)
        format.html { redirect_to @forma_pagamento, notice: t('message.update_success') }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to forma_pagamentos_url, notice: t('message.destroy_success') }
