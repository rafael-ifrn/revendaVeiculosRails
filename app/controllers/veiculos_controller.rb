class VeiculosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @veiculo.save
        format.html { redirect_to @veiculo, notice: t('message.create_success') }
  ...
  def update
    respond_to do |format|
      if @veiculo.update(veiculo_params)
        format.html { redirect_to @veiculo, notice: t('message.update_success') }
  ...
  private
    ...
    def veiculo_params
      params.require(:veiculo).permit(:anoFabricacao, :chassi, :placa, :cilindradas, :modelo_id, :imagem)
    end
end
