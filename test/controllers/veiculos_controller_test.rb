...
class VeiculosControllerTest < ActionController::TestCase
  ...
  test "should create veiculo" do
    assert_difference('Veiculo.count') do
      post :create, veiculo: { anoFabricacao: @veiculo.anoFabricacao, chassi: @veiculo.chassi, cilindradas: @veiculo.cilindradas, foto: @veiculo.foto, placa: @veiculo.placa }
    end
  ...
  test "should update veiculo" do
    patch :update, id: @veiculo, veiculo: { anoFabricacao: @veiculo.anoFabricacao, chassi: @veiculo.chassi, cilindradas: @veiculo.cilindradas, foto: @veiculo.foto, placa: @veiculo.placa }
    assert_redirected_to veiculo_path(assigns(:veiculo))
  end
