...
class VendasControllerTest < ActionController::TestCase
  ...
  test "should create venda" do
    assert_difference('Venda.count') do
      post :create, venda: { comissao: @venda.comissao, data: @venda.data, desconto: @venda.desconto, obs: @venda.obs, status: @venda.status }
    end
  ...
  test "should update venda" do
    patch :update, id: @venda, venda: { comissao: @venda.comissao, data: @venda.data, desconto: @venda.desconto, obs: @venda.obs, status: @venda.status }
    assert_redirected_to venda_path(assigns(:venda))
  end
